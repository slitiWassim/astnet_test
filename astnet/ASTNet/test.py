...
def main():
    ...
    frame_path='/content/astnet/ASTNet/data/frame_labels_'+config.DATASET.DATASET+'.npy'
    folder='/content/astnet/ASTNet/datasets/'+config.DATASET.DATASET+'/testing/frames'
